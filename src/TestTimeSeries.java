...
public class TestTimeSeries
{
    ...
    private static final float LEAF_NODE_PROBABILITY = 0.6f;
    private static final float MUTATION_PROBABILITY  = 0.5f;
    ...
    private static final int PRINT_LOG_INTERVAL     = 50;
    ...
    {
        TerminationCondition[] terminationConditions = TestTimeSeries.getTerminationConditions();
        EvolutionEngine<Node> engine                 = TestTimeSeries.getEvolutionEngine(data);
        TestTimeSeries.addEvolutionObservers(engine);
        return engine.evolve(TestTimeSeries.POPULATION_SIZE, TestTimeSeries.ELITISM_COUNT, terminationConditions);
    }
